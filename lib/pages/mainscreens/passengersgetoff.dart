// ignore_for_file: avoid_print, use_build_context_synchronously, no_leading_underscores_for_local_identifiers, unused_import
        ...
        if (bookingsData['Data'] != null && bookingsData['Data'] is List) {
          ...
          setState(() {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text('No Passenger(s) getting off'),
              ),
            );
          });
        }
              ...
              children: [
                ...
                const SizedBox(
                  height: 30,
                    ...
                    //                     if (driv != null)
                    //                       ...driv!.map((passenger) {
                    //                         String doref = drivt![index]
                    //                                 ['DocRefID']
                    //                             .toString();
                    //                         String pass = driv![index]
                    //                                 ['PasengerID']
                    //                             .toString();
                    //                         if (doref == pass) {
                    //                           return Column(
